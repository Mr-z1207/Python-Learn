...
with open('001_hello world.py', 'r') as file:
    data = file.read()
print(data)
# 详见Chrome收藏夹——杂七杂八
...
f = open('000test/txt/gbk.txt', 'r', encoding='gbk', errors='ignore')
f.close()

# 写文件
# 写文件和读文件是一样的，唯一区别是调用open()函数时，传入标识符'w'或者'wb'表示写文本文件或写二进制文件：
with open('000test/gbk.txt', 'w') as file:
    file.write('你好')
with open('000test/gbk.txt', 'r') as file:
    data = file.read()
print(data)
# 完整的语法格式为：
